...
export const toolDefinitionMap: Map<string, McpToolDefinition> = new Map([
  ...
  ["getGlobalFieldsMetadata", {
    ...
    inputSchema: {"type":"object","properties":{"resourceType":{"type":"string","description":"The Resource Type. Accepted values: workitems, documents, testruns and plans."},"targetType":{"type":"string","description":"The Type of the object. Use '~' without quotes to represent no target Type."}},"required":["resourceType"]},
    method: "get",
  ...
  ["deleteAllWorkItems", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workitems"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Work Item(s) body."}},"required":["requestBody"]},
    method: "delete",
    pathTemplate: "/all/workitems",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["deleteGlobalCustomFields", {
    ...
    inputSchema: {"type":"object","properties":{"resourceType":{"type":"string","description":"The Resource Type."},"targetType":{"type":"string","description":"The Type of the object. Use '~' without quotes to represent no target Type."}},"required":["resourceType","targetType"]},
    method: "delete",
    pathTemplate: "/customfields/{resourceType}/{targetType}",
  ...
  ["patchGlobalCustomFields", {
    ...
    inputSchema: {"type":"object","properties":{"resourceType":{"type":"string","description":"The Resource Type."},"targetType":{"type":"string","description":"The Custom Field target type. (Use '~' when there is no specific type for the Prototype.)"},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["customfields"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"fields":{"items":{"properties":{"defaultValue":{"type":"string"},"dependsOn":{"type":"string"},"description":{"type":"string"},"id":{"type":"string"},"name":{"type":"string"},"parameters":{"items":{"properties":{"key":{"type":"string"},"name":{"type":"string"},"title":{"type":"string"}},"type":"object"},"type":"array"},"required":{"type":"boolean"},"type":{"properties":{"kind":{"type":"string"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object","description":"Custom Fields Body"}},"required":["resourceType","targetType","requestBody"]},
    method: "patch",
    pathTemplate: "/customfields/{resourceType}/{targetType}",
    executionParameters: [{"name":"resourceType","in":"path"},{"name":"targetType","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postGlobalEnumeration", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["enumerations"],"type":"string"},"attributes":{"properties":{"enumContext":{"type":"string"},"enumName":{"type":"string"},"options":{"items":{"properties":{"color":{"type":"string"},"columnWidth":{"type":"string"},"createDefect":{"type":"boolean"},"default":{"type":"boolean"},"description":{"type":"string"},"hidden":{"type":"boolean"},"iconURL":{"type":"string"},"id":{"type":"string"},"limited":{"type":"boolean"},"minValue":{"type":"number"},"name":{"type":"string"},"oppositeName":{"type":"string"},"parent":{"type":"boolean"},"requiresSignatureForTestCaseExecution":{"type":"boolean"},"templateWorkItem":{"type":"string"},"terminal":{"type":"boolean"}},"type":"object"},"type":"array"},"targetType":{"type":"string"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Enumeration(s) body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/enumerations",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["patchGlobalEnumeration", {
    ...
    inputSchema: {"type":"object","properties":{"enumContext":{"type":"string","description":"The Enumeration context. (Allowed values are '~', 'plans', 'testing' and 'documents'. Use '~' for Work Item or general enumerations.)"},"enumName":{"type":"string","description":"The Enumeration Name."},"targetType":{"type":"string","description":"The Enumeration target type. (Use '~' when there is no specific type for the enumeration.)"},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["enumerations"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"options":{"items":{"properties":{"color":{"type":"string"},"columnWidth":{"type":"string"},"createDefect":{"type":"boolean"},"default":{"type":"boolean"},"description":{"type":"string"},"hidden":{"type":"boolean"},"iconURL":{"type":"string"},"id":{"type":"string"},"limited":{"type":"boolean"},"minValue":{"type":"number"},"name":{"type":"string"},"oppositeName":{"type":"string"},"parent":{"type":"boolean"},"requiresSignatureForTestCaseExecution":{"type":"boolean"},"templateWorkItem":{"type":"string"},"terminal":{"type":"boolean"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Enumeration(s) body."}},"required":["enumContext","enumName","targetType","requestBody"]},
    method: "patch",
    pathTemplate: "/enumerations/{enumContext}/{enumName}/{targetType}",
    executionParameters: [{"name":"enumContext","in":"path"},{"name":"enumName","in":"path"},{"name":"targetType","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchLicense", {
    name: "patchLicense",
    description: `Updates the product License.`,
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["license"],"type":"string"},"id":{"type":"string"},"relationships":{"properties":{"defaultAddOnLicenseSlots":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["license_slots"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"defaultBaseLicenseSlot":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["license_slots"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object","description":"The License body."}},"required":["requestBody"]},
    method: "patch",
    pathTemplate: "/license",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["getLicenseAssignments", {
    ...
    description: `Returns a list of License Assignments.`,
    inputSchema: {"type":"object","properties":{"page[size]":{"type":"number","format":"int32","description":"Limit the number of entities returned in a single response. See <a href=\"https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871\" target=\"_blank\">REST API User Guide</a> for details."},"page[number]":{"type":"number","format":"int32","description":"Specify the page number to be returned. Counting starts from 1. See <a href=\"https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871\" target=\"_blank\">REST API User Guide</a> for details."},"fields":{"type":"object","additionalProperties":{"type":"string","description":"Comma-separated list of fields to include for this resource type"},"description":"Filter returned resource fields. See <a href=\"https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871\" target=\"_blank\">REST API User Guide</a> for details."},"include":{"type":"string","description":"Include related entities. See <a href=\"https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871\" target=\"_blank\">REST API User Guide</a> for details."},"activeOnly":{"type":"boolean","description":"If set to true, only active (with status LOGGED_IN or EXPIRING) license assigments will be returned, otherwise all the license assignments will be returned."}}},
    method: "get",
  ...
  ["patchLicenseAssignments", {
    ...
    description: `Updates the License Assignments of multiple users.`,
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["license_assignments"],"type":"string"},"id":{"type":"string"},"relationships":{"properties":{"addOnSlots":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["license_slots"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"baseSlot":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["license_slots"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The User(s) license assignment body."}},"required":["requestBody"]},
    method: "patch",
    pathTemplate: "/license/assignments",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["getLicenseAssignmentsForUser", {
    ...
    description: `Returns the specified License Assignment.`,
  ...
  ["getLicenseSlots", {
    ...
    description: `Returns information on the available License Slots.`,
  ...
  ["deleteLicenseSlots", {
    ...
    description: `Deletes a list of Group license slots.`,
    inputSchema: {"type":"object","properties":{"typeId":{"type":"string","description":"License type."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["license_slots"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"No Content"}},"required":["typeId","requestBody"]},
    method: "delete",
    pathTemplate: "/license/types/{typeId}/slots",
    executionParameters: [{"name":"typeId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["getLicenseSlot", {
    name: "getLicenseSlot",
    description: `Returns the specified License Slot.`,
  ...
  ["getProjectFieldsMetadata", {
    ...
    description: `Metadata support is limited to the following resource types: **Work Items**, **Documents**, **Test Runs**, and **Plans**.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"resourceType":{"type":"string","description":"The Resource Type. Accepted values: workitems, documents, testruns and plans."},"targetType":{"type":"string","description":"The Type of the object. Use '~' without quotes to represent no target Type."}},"required":["projectId","resourceType"]},
    method: "get",
  ...
  ["moveProjectAction", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"location":{"description":"Location of the new Project to be created.","type":"string"}},"type":"object","description":"Move project parameters."}},"required":["projectId","requestBody"]},
    method: "post",
  ...
  ["postCollections", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections"],"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"id":{"type":"string"},"name":{"type":"string"}},"type":"object"},"relationships":{"properties":{"documents":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"revision":{"type":"string"},"type":{"enum":["documents"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"richPages":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["pages"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"testRuns":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["testruns"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"upstreamCollections":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"revision":{"type":"string"},"type":{"enum":["collections"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Collection(s) body."}},"required":["projectId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/collections",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteCollections", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Collection(s) body."}},"required":["projectId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/collections",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchCollections", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"collectionId":{"type":"string","description":"The Collection ID."},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["collections"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"name":{"type":"string"}},"type":"object"},"relationships":{"properties":{"documents":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"revision":{"type":"string"},"type":{"enum":["documents"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"richPages":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["pages"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"testRuns":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["testruns"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"upstreamCollections":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"revision":{"type":"string"},"type":{"enum":["collections"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Collection(s) body."}},"required":["projectId","collectionId","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/collections/{collectionId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"collectionId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteCollectionsRelationship", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"collectionId":{"type":"string","description":"The Collection ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Relationship body."}},"required":["projectId","collectionId","relationshipId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/collections/{collectionId}/relationships/{relationshipId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"collectionId","in":"path"},{"name":"relationshipId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchCollectionsRelationships", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"collectionId":{"type":"string","description":"The Collection ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"description":"The Relationship body.","oneOf":[{"properties":{"data":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"}},"type":"object"},{"properties":{"data":{"items":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}],"type":"object"}},"required":["projectId","collectionId","relationshipId","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/collections/{collectionId}/relationships/{relationshipId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"collectionId","in":"path"},{"name":"relationshipId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postProjectCustomFields", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["customfields"],"type":"string"},"attributes":{"properties":{"fields":{"items":{"properties":{"defaultValue":{"type":"string"},"dependsOn":{"type":"string"},"description":{"type":"string"},"id":{"type":"string"},"name":{"type":"string"},"parameters":{"items":{"properties":{"key":{"type":"string"},"name":{"type":"string"},"title":{"type":"string"}},"type":"object"},"type":"array"},"required":{"type":"boolean"},"type":{"properties":{"kind":{"type":"string"}},"type":"object"}},"type":"object"},"type":"array"},"resourceType":{"type":"string"},"targetType":{"type":"string"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"Custom Fields Body"}},"required":["projectId","requestBody"]},
    method: "post",
  ...
  ["deleteProjectCustomFields", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"resourceType":{"type":"string","description":"The Resource Type."},"targetType":{"type":"string","description":"The Type of the object. Use '~' without quotes to represent no target Type."}},"required":["projectId","resourceType","targetType"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/customfields/{resourceType}/{targetType}",
  ...
  ["patchCustomField", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"resourceType":{"type":"string","description":"The Resource Type."},"targetType":{"type":"string","description":"The Custom Field target type. (Use '~' when there is no specific type for the Prototype.)"},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["customfields"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"fields":{"items":{"properties":{"defaultValue":{"type":"string"},"dependsOn":{"type":"string"},"description":{"type":"string"},"id":{"type":"string"},"name":{"type":"string"},"parameters":{"items":{"properties":{"key":{"type":"string"},"name":{"type":"string"},"title":{"type":"string"}},"type":"object"},"type":"array"},"required":{"type":"boolean"},"type":{"properties":{"kind":{"type":"string"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object","description":"Custom Fields Body"}},"required":["projectId","resourceType","targetType","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/customfields/{resourceType}/{targetType}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"resourceType","in":"path"},{"name":"targetType","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchProjectEnumeration", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"enumContext":{"type":"string","description":"The Enumeration context. (Allowed values are '~', 'plans', 'testing' and 'documents'. Use '~' for Work Item or general enumerations.)"},"enumName":{"type":"string","description":"The Enumeration Name."},"targetType":{"type":"string","description":"The Enumeration target type. (Use '~' when there is no specific type for the enumeration.)"},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["enumerations"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"options":{"items":{"properties":{"color":{"type":"string"},"columnWidth":{"type":"string"},"createDefect":{"type":"boolean"},"default":{"type":"boolean"},"description":{"type":"string"},"hidden":{"type":"boolean"},"iconURL":{"type":"string"},"id":{"type":"string"},"limited":{"type":"boolean"},"minValue":{"type":"number"},"name":{"type":"string"},"oppositeName":{"type":"string"},"parent":{"type":"boolean"},"requiresSignatureForTestCaseExecution":{"type":"boolean"},"templateWorkItem":{"type":"string"},"terminal":{"type":"boolean"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Enumeration(s) body."}},"required":["projectId","enumContext","enumName","targetType","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/enumerations/{enumContext}/{enumName}/{targetType}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"enumContext","in":"path"},{"name":"enumName","in":"path"},{"name":"targetType","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deletePlans", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["plans"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Plan(s) body."}},"required":["projectId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/plans",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postPlanRelationships", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"planId":{"type":"string","description":"The Plan ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"description":"The Work Item(s) body.","oneOf":[{"properties":{"data":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"}},"type":"object"},{"properties":{"data":{"items":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}],"type":"object"}},"required":["projectId","planId","relationshipId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/plans/{planId}/relationships/{relationshipId}",
  ...
  ["deletePlanRelationship", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"planId":{"type":"string","description":"The Plan ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Relationship body."}},"required":["projectId","planId","relationshipId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/plans/{planId}/relationships/{relationshipId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"planId","in":"path"},{"name":"relationshipId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchDocumentAttachment", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"documentName":{"type":"string","description":"The Document name."},"attachmentId":{"type":"string","description":"The Attachment ID."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","spaceId","documentName","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/documents/{documentName}/attachments/{attachmentId}",
  ...
  ["postDocumentComments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"documentName":{"type":"string","description":"The Document name."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["document_comments"],"type":"string"},"attributes":{"properties":{"resolved":{"type":"boolean"},"text":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"}},"type":"object"},"relationships":{"properties":{"author":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"},"parentComment":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["document_comments"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Comment(s) body."}},"required":["projectId","spaceId","documentName","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/documents/{documentName}/comments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"documentName","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postDocumentParts", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"documentName":{"type":"string","description":"The Document name."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["document_parts"],"type":"string"},"attributes":{"properties":{"layout":{"format":"int32","type":"number"},"level":{"format":"int32","type":"number"},"type":{"type":"string"}},"type":"object"},"relationships":{"properties":{"nextPart":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["document_parts"],"type":"string"}},"type":"object"}},"type":"object"},"previousPart":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["document_parts"],"type":"string"}},"type":"object"}},"type":"object"},"workItem":{"properties":{"data":{"properties":{"id":{"type":"string"},"revision":{"type":"string"},"type":{"enum":["workitems"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Document Part(s) body."}},"required":["projectId","spaceId","documentName","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/documents/{documentName}/parts",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"documentName","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["moveDocumentParts", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"documentName":{"type":"string","description":"The Document name."},"partId":{"type":"string","description":"The Document Part ID."},"requestBody":{"properties":{"after":{"type":"string"},"before":{"type":"string"},"parent":{"type":"string"}},"type":"object","description":"References for repositioning Work Item Document Part in the Document."}},"required":["projectId","spaceId","documentName","partId","requestBody"]},
    method: "post",
  ...
  ["postPages", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["pages"],"type":"string"},"attributes":{"properties":{"homePageContent":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"pageName":{"type":"string"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"author":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Page(s) body."}},"required":["projectId","spaceId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deletePage", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."}},"required":["projectId","spaceId","pageName"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}",
  ...
  ["patchRichPage", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["pages"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"homePageContent":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"watches":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Page body."}},"required":["projectId","spaceId","pageName","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"pageName","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postPageAttachments", {
    ...
    description: `Files are identified by order or optionally by the 'lid' attribute. See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string"},"spaceId":{"type":"string"},"pageName":{"type":"string"},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","spaceId","pageName","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"pageName","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["deletePageAttachment", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"attachmentId":{"type":"string","description":"The Attachment ID."}},"required":["projectId","spaceId","pageName","attachmentId"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/attachments/{attachmentId}",
  ...
  ["patchPageAttachment", {
    ...
    description: `See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"attachmentId":{"type":"string","description":"The Attachment ID."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","spaceId","pageName","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/attachments/{attachmentId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"pageName","in":"path"},{"name":"attachmentId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["postPageComments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["page_comments"],"type":"string"},"attributes":{"properties":{"resolved":{"type":"boolean"},"text":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"}},"type":"object"},"relationships":{"properties":{"author":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"},"parentComment":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["page_comments"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Comment(s) body."}},"required":["projectId","spaceId","pageName","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/comments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"pageName","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postPageRelationships", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"description":"The Relationship body.","oneOf":[{"properties":{"data":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"}},"type":"object"},{"properties":{"data":{"items":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}],"type":"object"}},"required":["projectId","spaceId","pageName","relationshipId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/relationships/{relationshipId}",
  ...
  ["deletePageRelationships", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"spaceId":{"type":"string","description":"The Space ID. (Use '_default' without quotes to address the default Space.)"},"pageName":{"type":"string","description":"The Page name."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Relationship body."}},"required":["projectId","spaceId","pageName","relationshipId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/spaces/{spaceId}/pages/{pageName}/relationships/{relationshipId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"spaceId","in":"path"},{"name":"pageName","in":"path"},{"name":"relationshipId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteProjectTestParameterDefinitions", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testparameter_definitions"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Parameter Definition(s) body."}},"required":["projectId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testparameterdefinitions",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteTestRuns", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testruns"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Run(s) body."}},"required":["projectId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testruns",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postTestRunAttachments", {
    ...
    description: `Files are identified by order or optionally by the 'lid' attribute. See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string"},"testRunId":{"type":"string"},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["deleteTestRunAttachments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testrun_attachments"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Run Attachment(s) body."}},"required":["projectId","testRunId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchTestRunAttachment", {
    ...
    description: `See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string"},"testRunId":{"type":"string"},"attachmentId":{"type":"string"},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/attachments/{attachmentId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"attachmentId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["postTestRunComments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testrun_comments"],"type":"string"},"attributes":{"properties":{"resolved":{"type":"boolean"},"text":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"author":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"},"parentComment":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["testrun_comments"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Comment(s) body."}},"required":["projectId","testRunId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/comments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteTestRunTestParameters", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testparameters"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Parameter(s) body."}},"required":["projectId","testRunId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testparameters",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchTestRecords", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testrecords"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"comment":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"duration":{"type":"number"},"executed":{"format":"date-time","type":"string"},"result":{"type":"string"},"testCaseRevision":{"type":"string"}},"type":"object"},"relationships":{"properties":{"defect":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["workitems"],"type":"string"}},"type":"object"}},"type":"object"},"executedBy":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Record(s) body."}},"required":["projectId","testRunId","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postTestRecordAttachments", {
    ...
    description: `Files are identified by order or optionally by the 'lid' attribute. See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["deleteTestRecordAttachments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["testrecord_attachments"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Record Attachment(s) body."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchTestRecordAttachment", {
    ...
    description: `See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"attachmentId":{"type":"string","description":"The Attachment ID."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/attachments/{attachmentId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"},{"name":"attachmentId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["postTestStepResultAttachments", {
    ...
    description: `Files are identified by order or optionally by the 'lid' attribute. See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"testStepIndex":{"type":"string","description":"The Test Step index."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","testStepIndex","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/teststepresults/{testStepIndex}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"},{"name":"testStepIndex","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["deleteTestStepResultAttachments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"testStepIndex":{"type":"string","description":"The Test Step index."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["teststepresult_attachments"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Step Result Attachment(s) body."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","testStepIndex","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/teststepresults/{testStepIndex}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"},{"name":"testStepIndex","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchTestStepResultAttachment", {
    ...
    description: `See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"testRunId":{"type":"string","description":"The Test Run ID."},"testCaseProjectId":{"type":"string","description":"The Testcase Project ID."},"testCaseId":{"type":"string","description":"The Testcase ID."},"iteration":{"type":"string","description":"The Iteration Number."},"testStepIndex":{"type":"string","description":"The Test Step index."},"attachmentId":{"type":"string","description":"The Attachment ID."},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","testRunId","testCaseProjectId","testCaseId","iteration","testStepIndex","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/testruns/{testRunId}/testrecords/{testCaseProjectId}/{testCaseId}/{iteration}/teststepresults/{testStepIndex}/attachments/{attachmentId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"testRunId","in":"path"},{"name":"testCaseProjectId","in":"path"},{"name":"testCaseId","in":"path"},{"name":"iteration","in":"path"},{"name":"testStepIndex","in":"path"},{"name":"attachmentId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["deleteWorkItems", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workitems"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Work Item(s) body."}},"required":["projectId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems",
    executionParameters: [{"name":"projectId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchWorkItems", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workflowAction":{"type":"string","description":"The Workflow Action."},"changeTypeTo":{"type":"string","description":"The Type the Workitem to change to."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workitems"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"dueDate":{"format":"date","type":"string"},"hyperlinks":{"items":{"properties":{"role":{"type":"string"},"title":{"type":"string"},"uri":{"type":"string"}},"type":"object"},"type":"array"},"initialEstimate":{"type":"string"},"priority":{"type":"string"},"remainingEstimate":{"type":"string"},"resolution":{"type":"string"},"resolvedOn":{"format":"date-time","type":"string"},"severity":{"type":"string"},"status":{"type":"string"},"timeSpent":{"type":"string"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"assignee":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"categories":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["categories"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"linkedRevisions":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["revisions"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"votes":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"watches":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Work Item(s) body."}},"required":["projectId","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/workitems",
  ...
  ["patchWorkItem", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"workflowAction":{"type":"string","description":"The Workflow Action."},"changeTypeTo":{"type":"string","description":"The Type the Workitem to change to."},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["workitems"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"dueDate":{"format":"date","type":"string"},"hyperlinks":{"items":{"properties":{"role":{"type":"string"},"title":{"type":"string"},"uri":{"type":"string"}},"type":"object"},"type":"array"},"initialEstimate":{"type":"string"},"priority":{"type":"string"},"remainingEstimate":{"type":"string"},"resolution":{"type":"string"},"resolvedOn":{"format":"date-time","type":"string"},"severity":{"type":"string"},"status":{"type":"string"},"timeSpent":{"type":"string"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"assignee":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"categories":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["categories"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"linkedRevisions":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["revisions"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"votes":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"watches":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Work Item body."}},"required":["projectId","workItemId","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}",
  ...
  ["postWorkItemApprovals", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workitem_approvals"],"type":"string"},"attributes":{"properties":{"status":{"enum":["waiting","approved","disapproved"],"type":"string"}},"type":"object"},"relationships":{"properties":{"user":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Linked Work Item(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/approvals",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postWorkItemAttachments", {
    ...
    description: `Files are identified by order or optionally by the 'lid' attribute. See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string"},"workItemId":{"type":"string"},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","workItemId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/attachments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["patchWorkItemAttachment", {
    ...
    description: `See more in the <a href="https://docs.sw.siemens.com/en-US/doc/230235217/PL20250606201928474.polarion_help_sc.xid2134849/xid2134871" target="_blank">REST API User Guide</a>.`,
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string"},"workItemId":{"type":"string"},"attachmentId":{"type":"string"},"requestBody":{"type":"string","description":"Attachment metadata and file data."}},"required":["projectId","workItemId","attachmentId"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/attachments/{attachmentId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"},{"name":"attachmentId","in":"path"}],
    requestBodyContentType: "multipart/form-data",
  ...
  ["postComments", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workitem_comments"],"type":"string"},"attributes":{"properties":{"resolved":{"type":"boolean"},"text":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"title":{"type":"string"}},"type":"object"},"relationships":{"properties":{"author":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"},"parentComment":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["workitem_comments"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Comment(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/comments",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteExternallyLinkedWorkItems", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["externallylinkedworkitems"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Work Item(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/externallylinkedworkitems",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteLinkedWorkItems", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["linkedworkitems"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Linked Work Item(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/linkedworkitems",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postWorkItemRelationships", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"description":"The Relationship body.","oneOf":[{"properties":{"data":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"}},"type":"object"},{"properties":{"data":{"items":{"properties":{"id":{"example":"MyProjectId/MyResourceId","type":"string"},"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}],"type":"object"}},"required":["projectId","workItemId","relationshipId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/relationships/{relationshipId}",
  ...
  ["deleteWorkItemsRelationship", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"relationshipId":{"type":"string","description":"The Relationship ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["collections","categories","documents","document_attachments","document_comments","document_parts","enumerations","globalroles","icons","jobs","linkedworkitems","externallylinkedworkitems","linkedoslcresources","pages","page_attachments","page_comments","plans","projectroles","projectgroups","projects","projecttemplates","spaces","testparameters","testparameter_definitions","testrecords","teststep_results","testruns","testrun_attachments","teststepresult_attachments","testrun_comments","usergroups","users","workitems","workitem_attachments","workitem_approvals","workitem_comments","featureselections","teststeps","workrecords","revisions","testrecord_attachments","license_slots","license_types","license","metadata","license_assignments","customfields"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Relationship body."}},"required":["projectId","workItemId","relationshipId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/relationships/{relationshipId}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"},{"name":"relationshipId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postTestSteps", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["teststeps"],"type":"string"},"attributes":{"properties":{"keys":{"items":{"type":"string"},"type":"array"},"values":{"items":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Step(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/teststeps",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteTestSteps", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["teststeps"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Test Step(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/teststeps",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["patchTestStep", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"testStepIndex":{"type":"string","description":"The Test Step index."},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["teststeps"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"keys":{"items":{"type":"string"},"type":"array"},"values":{"items":{"properties":{"type":{"enum":["text/html","text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object","description":"The Test Step(s) body."}},"required":["projectId","workItemId","testStepIndex","requestBody"]},
    method: "patch",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/teststeps/{testStepIndex}",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"},{"name":"testStepIndex","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["postWorkRecords", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workrecords"],"type":"string"},"attributes":{"properties":{"comment":{"type":"string"},"date":{"format":"date","type":"string"},"timeSpent":{"type":"string"},"type":{"type":"string"}},"type":"object"},"relationships":{"properties":{"user":{"properties":{"data":{"properties":{"id":{"type":"string"},"type":{"enum":["users"],"type":"string"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The Linked Work Item(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "post",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/workrecords",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["deleteWorkRecords", {
    ...
    inputSchema: {"type":"object","properties":{"projectId":{"type":"string","description":"The Project ID."},"workItemId":{"type":"string","description":"The Work Item ID."},"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["workrecords"],"type":"string"},"id":{"type":"string"}},"type":"object"},"type":"array"}},"type":"object","description":"The Work Record(s) body."}},"required":["projectId","workItemId","requestBody"]},
    method: "delete",
    pathTemplate: "/projects/{projectId}/workitems/{workItemId}/workrecords",
    executionParameters: [{"name":"projectId","in":"path"},{"name":"workItemId","in":"path"}],
    requestBodyContentType: "application/json",
  ...
  ["createProject", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"location":{"description":"Location of the new Project to be created.","type":"string"},"params":{"description":"Parameters of new Project to be created.","type":["object","null"]},"projectId":{"description":"Id of the new Project to be created.","type":"string"},"templateId":{"description":"Id of the template to create the new Project from.","type":["string","null"]},"trackerPrefix":{"description":"Tracker prefix of the new Project to be created.","type":"string"}},"type":"object","description":"Create project parameters."}},"required":["requestBody"]},
    method: "post",
  ...
  ["postUsers", {
    ...
    inputSchema: {"type":"object","properties":{"requestBody":{"properties":{"data":{"items":{"properties":{"type":{"enum":["users"],"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"disabledNotifications":{"type":"boolean"},"email":{"type":"string"},"id":{"type":"string"},"initials":{"type":"string"},"name":{"type":"string"}},"required":["id"],"type":"object"},"relationships":{"properties":{"globalRoles":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["globalroles"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"projectRoles":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["projectroles"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"userGroups":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["usergroups"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"},"type":"array"}},"type":"object","description":"The User(s) body."}},"required":["requestBody"]},
    method: "post",
    pathTemplate: "/users",
    executionParameters: [],
    requestBodyContentType: "application/json",
  ...
  ["patchUser", {
    ...
    inputSchema: {"type":"object","properties":{"userId":{"type":"string","description":"The User ID."},"requestBody":{"properties":{"data":{"properties":{"type":{"enum":["users"],"type":"string"},"id":{"type":"string"},"attributes":{"properties":{"description":{"properties":{"type":{"enum":["text/plain"],"type":"string"},"value":{"type":"string"}},"type":"object"},"disabledNotifications":{"type":"boolean"},"email":{"type":"string"},"initials":{"type":"string"},"name":{"type":"string"}},"type":"object"},"relationships":{"properties":{"globalRoles":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["globalroles"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"projectRoles":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["projectroles"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"},"userGroups":{"properties":{"data":{"items":{"properties":{"id":{"type":"string"},"type":{"enum":["usergroups"],"type":"string"}},"type":"object"},"type":"array"}},"type":"object"}},"type":"object"}},"type":"object"}},"type":"object","description":"The User body."}},"required":["userId","requestBody"]},
    method: "patch",
    pathTemplate: "/users/{userId}",
  ...
  ["setLicense", {
    ...
    inputSchema: {"type":"object","properties":{"userId":{"type":"string","description":"The User ID."},"requestBody":{"properties":{"concurrent":{"description":"Is concurrent user","type":"boolean"},"group":{"description":"License group","type":"string"},"license":{"description":"User's license type","enum":["REVIEWER","XReviewer","XBase","XEssentials","XPro","XStandard","XEnterprise","XAdvanced","XExtended","XPremium","XAutomotive","PRO","REQUIREMENTS","QA","ALM"],"type":"string"}},"type":"object","description":"The user license body."}},"required":["userId","requestBody"]},
    method: "post",
